...
loc <- IlluminaHumanMethylationEPICanno.ilm10b2.hg19::Locations
...
saveRDS(region3_200, "InterGene_3_200EPIC.rds")

### remove chrx and chrY ###

region <- readRDS("InterGene_3_200EPIC.rds")
...
saveRDS(regionNoXY, "InterGene_3_200EPIC.rds")
