...
```{r load_sesameData,message=FALSE, eval = FALSE}
library(sesameData)
sesameDataCacheAll()
```
...
```{r message = FALSE}
# TO DO 2021-05-02: give an example of how to find the CpGs associated with a
#   specific gene, then assume the user has done so.
